# for반복 : for~in, for~not in, for~in~range
data = [90, 80, 100, 60, 70]
a = tot = 0
for i in data:  # 순서대로 넣어서 출력함
    a += 1
    tot += i
    print("점수 : ", i)
print("총점 :", tot)
...
for (kor, eng, mat) in jum:  # 알아서 넣어서 출력해줌
...
b1 = range(10) #레인지=범위 #0~9 
for i in b1:
    print(i)

b2 = range(0,6) #0~5 (스타트값, 이값전까지) 정수
for i in b2:
    print(i)

b3 = range(0,10,2) (start, end, step)
for i in b3:
    print(i)
